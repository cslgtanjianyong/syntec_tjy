...
import com.example.cslg.util.SystemUiHider;
	...
	e.printStackTrace();
		...
		TimerTask task = new TimerTask(){   
		    public void run(){
		    	...
		    	if (iSonelogin=="") 
		    	{
		    	Intent intent = new Intent(LoginActivity.this,mainSreen.class); 
			    startActivity(intent); 
		     	Intent intentq = new Intent(LoginActivity.this,ScrollUIActivity.class);
